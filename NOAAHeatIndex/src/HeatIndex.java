...
public class HeatIndex 
{
	public static void main(String args[])
	{
		...
		while(start==true)
		{
			...
			double humidInput=in.nextDouble();
			
			double result2=(int)(-42.379+(2.04901523*input)+(10.14333127*humidInput)-(0.22475541*input*humidInput)-(0.00683783*input*input)-(0.05481717*humidInput*humidInput)+(0.00122874*input*input*humidInput)+(0.00085282*input*humidInput*humidInput)-(0.00000199*input*input*humidInput*humidInput));
			System.out.println("The THI for a temperature of "+input+" and relative of "+humidInput+" is: "+result2);
